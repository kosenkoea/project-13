(() => {
    ...
    const heightBtn = footerBtn.offsetHeight;
    const footerCnt = document.querySelector(".footer");
    const heightCnt = footerCnt.offsetHeight;
    const body = document.body;
    footerCnt.style.bottom = `${-(heightCnt - heightBtn)}px`;
    body.classList.add("footer_close");
    footerBtn.addEventListener("click", (function(e) {
        body.classList.toggle("footer_close");
        if (body.classList.contains("footer_close")) footerCnt.style.bottom = `${-(heightCnt - heightBtn)}px`; else footerCnt.style.bottom = `${-0}px`;
    }));
    window["FLS"] = true;
    isWebp();
    addLoadedClass();
